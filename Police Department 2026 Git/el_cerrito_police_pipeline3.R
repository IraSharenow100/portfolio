...
# EC Plaza BART). After 7B: TBD -- compare maps; Del Norte gained 9
...
response_fy %>%
  ...
  print(n = 20)
# Result: TBD. If most types got faster, the speedup is broad. If types
# are about the same, the change is in the mix of calls.
...
# --- Greenway: FY 2025-26 vs 2019-25 per year, same text rules ---
